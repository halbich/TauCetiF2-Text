...
Aby byla práce co nejjednodušší, metody přijímají enumerátor \TT{EGameUserSettingsVariable}. Třída pak sama na základě hodnoty tohoto enumerátoru použije správný klíč (který je textový) a~tak může ukládat či vracet hodnotu daného typu z~konfiguračního souboru.