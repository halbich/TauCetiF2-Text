...
\SE{} umožňuje stavět pohyblivé stroje, které si hráč postaví z~herních bloků a~ty se pak dohromady chovají jako jedna entita. Stále je na ně však aplikována fyzika, takže je možné plavidlo poškodit, nebo dokonce zničit. Obdobně lze ve hře \SE{} stavět různá mechanická obléhací zařízení, například pojízdné katapulty.
