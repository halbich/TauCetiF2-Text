...
Jediný tvar, který budeme chtít umět rozpoznat, bude tvar objektu \textit{Konstruktoru objektů}. Abychom měli jednoznačný vstup do výpočetního stromu tvaru (TODO strom musí být dříve zmíněn), řekneme, že konstruktor musí obsahovat speciální blok \RB{B7}. Ten se bude vázat k~ostatním blokům stejného typu. Chceme, aby konstruktor objektů vypadal následovně:
